  ...
  <div className="fixed inset-0 flex z-40 lg:hidden" role="dialog" aria-modal="true">
    ...
    <div className="relative max-w-xs w-full bg-white shadow-xl pb-12 flex flex-col overflow-y-auto">
      ...
      <div className="px-4 pt-5 pb-2 flex">
        <button type="button" className="-m-2 p-2 rounded-md inline-flex items-center justify-center text-gray-400" onClick = {(e)=> setToggle(!toggle)}>
      ...
      <div className="border-t border-gray-200 py-6 px-4 space-y-6">
        <div className="flow-root">
          <a href="#event" className="-m-2 p-2 block font-medium text-gray-900">Events</a>
        </div>

        <div className="flow-root">
          <a href="#test" className="-m-2 p-2 block font-medium text-gray-900">Testomonial</a>
        </div>
      </div>
    ...
    <nav aria-label="Top" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="border-b border-gray-200">
        <div className="h-16 flex items-center">
          ...
          <button type="button" className="bg-white p-2 rounded-md text-gray-400 lg:hidden" onClick = {()=> setToggle(!toggle)}>
          ...
          <div className="ml-auto flex items-center">
            <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
              ...
              <a href="#" className="text-sm font-medium text-gray-700 hover:text-gray-800" ><Link to = {"/view"}> Admin </Link> </a>)}
