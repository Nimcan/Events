        ...
        <div class="py-8">
            ...
            <div class="my-2 flex sm:flex-row flex-col">
                <div class="flex flex-row mb-1 sm:mb-0">
                    <div class="relative">
                        <select
                            class="appearance-none h-full rounded-l border sm:rounded-r-none sm:border-r-0 border-r border-b block appearance-none w-full bg-white border-gray-400 text-gray-700 py-2 px-4 pr-8 leading-tight focus:outline-none focus:border-l focus:border-r focus:bg-white focus:border-gray-500">
                            <option>All</option>
                    ...
                    <table class="min-w-full leading-normal">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="px-3 py-3 border-b border-gray-200 bg-white text-sm">
                                    <p class="text-gray-900 whitespace-no-wrap">{all.eventType}</p>
                                </td>
                                <td class="px-3 py-3 border-b border-gray-200 bg-white text-sm">
                                    <p class="text-gray-900 whitespace-no-wrap">
                                      {all.date}
                                ...
                                <td class="px-3 py-3 border-b border-gray-200 bg-white text-sm text-center">
									<input type = "checkbox" className = "h-5 w-4 items-center" onClick = {()=> Fullfilled(all._id)}/>
