...
function View(){
   ...
   <div className="h-3/4 flex flex-col justify-around text-gray-500">
      <h3 className="pl-1 text-sm flex items-center py-2 mb-2 hover:bg-gray-100 hover:text-gray-700 transition duration-200 ease-in" onClick = {(e)=> setTab("Add")}>
        <i class="fas fa-calendar-plus mr-3 text-center text-black text-xl"></i>
         <a className="hover:text-black transition duration-200 ease-linear" href="#">  Add Event</a>
      </h3>

      <h3 className="pl-1 text-sm flex items-center py-2 mb-2 hover:bg-gray-100 hover:text-gray-700 transition duration-200 ease-in" onClick = {(e)=> JSON.parse(localStorage.getItem('user')).role == 'admin' && setTab("list")}>
         <i class="fas fa-users mr-2 text-center text-black text-xl"></i>
         <a className="hover:text-black transition duration-200 ease-linear" href="#" >User List</a>
      </h3>
      <h3 className="pl-1 text-sm flex items-center py-2 mb-2 hover:bg-gray-100 hover:text-gray-700 transition duration-200 ease-in" onClick = {(e)=> JSON.parse(localStorage.getItem('user')).role == 'admin' && setTab("create")}>
         <i class="fas fa-user-plus mr-2 text-center text-black text-lg" viewBox="0 0 20 20" fill="black"></i>
         <a className="hover:text-black transition duration-200 ease-linear" href="#" >Create User</a>
      </h3>
      <h3 className="pl-1 text-sm flex items-center py-2 mb-2 hover:bg-gray-100 hover:text-gray-700 transition duration-200 ease-in"  onClick = {(e)=> JSON.parse(localStorage.getItem('user')).role == 'admin' &&  setTab("message")}>
      ...
      <h3 className="pl-1 text-sm flex items-center py-2 mb-2 hover:bg-gray-100 hover:text-gray-700 transition duration-200 ease-in" onClick = {()=> logOut()} >
         ...
         <a className="hover:text-black transition duration-200 ease-linear" href="#" >Log Out</a>
      </h3>
   </div>
