              ...
              <div className="shadow overflow-hidden sm:rounded-md">
                <div className="px-4 py-5 bg-white sm:p-6">
                  <div className="grid grid-cols-6 gap-6">
                    ...
                    <div className="col-span-6 sm:col-span-4">
                      <label for="email-address" className="block text-sm font-medium text-gray-700">Guest Name</label>
                    ...
                    <div className="col-span-6 sm:col-span-3">
                      ...
                      <select id="country" name="country" autocomplete="country" className="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        ...
                        <option>Burco</option>
                        <option>Laascanood</option>
                        <option>Ceerigaabo</option>
                        <option>Gabiley</option>
                        <option>Boorama</option>
                        <option>Jigjiga</option>
                        <option>Moqdisho</option>
                        <option>Garoowe</option>
                      </select>
                    </div>
      
                    <div className="col-span-6 sm:col-span-4">
                      <label for="street-address" className="block text-sm font-medium text-gray-700">Address</label>
